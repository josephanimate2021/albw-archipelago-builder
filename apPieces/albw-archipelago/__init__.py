...
class ALBWWorld(World):
    ...
    seed: Optional[int]
    seed_info: Optional[albwrandomizer.SeedInfo]
    ...
    def generate_early(self) -> None:
        ...
        for num_tries in range(max_tries + 1):
            ...
            self.seed_info = albwrandomizer.randomize_pre_fill(self.seed, settings, archipelago_info)
    ...
    def _convert_state(self, state: CollectionState) -> List[albwrandomizer.PyRandomizable]:
        randomizables = []
