            ...
            try {
                ...
                function checkPathsExistance() {
                    return {
                        ...
                        ) || (process.platform == "linux" && fs.existsSync(path.join(userHomePath, ".local/bin/maturin")))
                    }
                }
...
function continueBuildingWithBuffer(buffer, ws) {
    return new Promise(async (res, rej) => {
        try {
            ...
            randoLibContents = replaceWithPyClassAndOriginal(randoLibContents, 'version: VERSION.to_owned(),', archipelagoInfoNone, 2);
